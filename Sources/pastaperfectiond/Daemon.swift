...
public final class Daemon {
    ...
    /// (see `run()`).
    public let stateQueue = DispatchQueue(label: "com.pastaperfection.daemon.state")
    ...
    public static func liveAdapter() -> SMCAdapter {
        ...
        do {
            ...
            FileHandle.standardError.write(Data("pastaperfectiond: warning: failed to open SMC connection: \(error)\n".utf8))
        }
    ...
    private func installSocketServer() {
        ...
        do {
            ...
            FileHandle.standardError.write(Data("pastaperfectiond: warning: failed to start socket server: \(error)\n".utf8))
        }
    }
