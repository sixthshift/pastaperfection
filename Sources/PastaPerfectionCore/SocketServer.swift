...
public final class SocketServer {
    ...
    private let queue = DispatchQueue(label: "com.pastaperfection.socketserver")
    ...
    private final class Connection {
        ...
        private let queue = DispatchQueue(label: "com.pastaperfection.socketserver.connection")
